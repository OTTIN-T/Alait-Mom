<template>
  <div
    ...
    <div
      class="absolute -top-8 left-10 flex flex-col items-center justify-center rounded-xl border border-solid border-my-accent dark:border-my-accent-800 bg-my-accent dark:bg-my-accent-500 px-8 py-5 [box-shadow:rgb(0,_0,_0)_4px_4px]">
